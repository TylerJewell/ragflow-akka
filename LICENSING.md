...
A `LICENSE-ragflow` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [infiniflow/ragflow](https://github.com/infiniflow/ragflow), Copyright
the infiniflow/ragflow authors, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../ragflow-port/specs/SPEC-001-ragflow.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
